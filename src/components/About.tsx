...
const About: React.FC<SectionProps> = ({ id }) => {
  return (
    <>
      <section id={id} className="min-h-[40vh] flex flex-col items-center justify-center px-14 xs:px-4 py-10 bg-gradient-to-br from-indigo-300 to-indigo-500 mb-[1200px]">
