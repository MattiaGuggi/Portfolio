    ...
    <section id="contact" className="min-h-[40vh] flex flex-col items-center justify-center px-4 py-10">
        <div className="max-w-xl mx-auto text-center">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full px-6 py-2 rounded bg-indigo-700 text-white font-semibold hover:bg-indigo-800 transition-all duration-400 hover:scale-105">Send</button>
          </form>
        </div>
    </section>
  );
